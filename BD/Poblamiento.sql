INSERT INTO `UNIONLINE`.`TIPO_PAGO` (`id_tipoP`, `nombre_tipoP`) VALUES 
(1, "Redcompra"),
(2, "Efectivo");
...
INSERT INTO `UNIONLINE`.`PROVINCIA` (`id_provincia`,`nombre_provincia`,`REGION_id_region`)
VALUES
	(1,'Arica',1),
	(2,'Parinacota',1),
	(3,'Iquique',2),
...
INSERT INTO `UNIONLINE`.`COMUNA` (`id_comuna`,`nombre_comuna`,`PROVINCIA_id_provincia`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',2),
